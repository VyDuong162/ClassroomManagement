...
--
-- Table structure for table `classroom_classes`
--
...
--
-- Table structure for table `classroom_joins`
--
...
--
-- Table structure for table `classroom_sections`
--
...
--
-- Table structure for table `classroom_stream`
--
...
--
-- Table structure for table `classroom_submits`
--
...
('tlkykn3uxj4oz7kynmmbskxfrwk4s4p5', 'eyJVc2VyX0xvZ2luIjoiVGhhbmhOZ3V5ZW4ifQ:1o3xzy:8b8vhEjQhxh8MVk5IhVoMr1AgQ1OC5_nn01HTcN2Z8s', '2022-07-06 10:54:14.288056');
...
--
-- Indexes for table `classroom_assignment`
--
...
--
-- Indexes for table `classroom_classes`
--
...
--
-- Indexes for table `classroom_joins`
--
...
--
-- Indexes for table `classroom_sections`
--
...
--
-- Indexes for table `classroom_stream`
--
...
--
-- Indexes for table `classroom_submits`
--
...
--
-- AUTO_INCREMENT for table `classroom_joins`
--
ALTER TABLE `classroom_joins`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `classroom_submits`
--
ALTER TABLE `classroom_submits`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `classroom_classes`
--
ALTER TABLE `classroom_classes`
...
--
-- Constraints for table `classroom_classroom`
--
ALTER TABLE `classroom_classroom`
...
--
-- Constraints for table `classroom_joins`
--
ALTER TABLE `classroom_joins`
...
--
-- Constraints for table `classroom_sections`
--
ALTER TABLE `classroom_sections`
...
--
-- Constraints for table `classroom_submits`
--
ALTER TABLE `classroom_submits`
